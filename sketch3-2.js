...
function setup() {
  ...
  imgArray[0].src = 'iyengar/triangle-4.png';
  imgArray[1] = new Image();
  imgArray[1].src = 'iyengar/war1-5.png';
  imgArray[2] = new Image();
  imgArray[2].src = 'iyengar/side-6.png';
  ...
  const modelInfo = {
    model: 'iyengar-pose/model-i2.json',
    metadata: 'iyengar-pose/model_meta-i2.json',
    weights: 'iyengar-pose/model.weights-i2.bin',
  };
...
function nextPose(){
  ...
  if (poseCounter >= 2) {
    ...
    $(document).ready(function(){
      $('#modal-create-iyengar').modal();
      $('#modal-create-iyengar').modal('open'); 
   });
  }else{
    iterationCounter = 0;
    iterationCounter2 = 0;
...
function draw() {
  ...
  if (poseLabel == 'c'){
    fill(245,189,224);
    text("Downward Dog correct!",width/2,height/7);
  }
}