...
let posesArray = ['Mountain', 'Cresent Moon','Half way'];
...
function setup() {
  ...
  imgArray[0].src = 'vinyasa/moun2-1.png';
  imgArray[1] = new Image();
  imgArray[1].src = 'vinyasa/cresent-2.png';
  imgArray[2] = new Image();
  imgArray[2].src = 'vinyasa/half-3.png';
  ...
  const modelInfo = {
    model: 'vinyasa-pose/model-v1.json',
    metadata: 'vinyasa-pose/model_meta-v1.json',
    weights: 'vinyasa-pose/model.weights-v1.bin',
  };
...
function draw() {
  ...
  if (poseLabel == 'b'){
    fill(86,149,232);
    text("Cresent Moon correct!",width/2,height/7);
  }
  if (poseLabel == 'c'){
    fill(245,189,224);
    text("Half way correct!",width/2,height/7);
  }
}