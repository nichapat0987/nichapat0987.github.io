...
let posesArray = ['Chair', 'Side angle','Warrior I'];
...
function setup() {
  ...
  imgArray[0].src = 'vinyasa/chair-4.png';
  imgArray[1] = new Image();
  imgArray[1].src = 'vinyasa/angle-5.png';
  imgArray[2] = new Image();
  imgArray[2].src = 'vinyasa/warrior1-6.png';
  ...
  const modelInfo = {
    model: 'vinyasa-pose/model-v2.json',
    metadata: 'vinyasa-pose/model_meta-v2.json',
    weights: 'vinyasa-pose/model.weights-v2.bin',
  };
...
function nextPose(){
  ...
  if (poseCounter >= 2) {
    ...
    $(document).ready(function(){
      $('#modal-create-vinyasa').modal();
      $('#modal-create-vinyasa').modal('open'); 
   });
  }else{
    iterationCounter = 0;
    iterationCounter2 = 0;
...
function draw() {
  ...
  if (poseLabel == 'b'){
    fill(86,149,232);
    text("Side angle correct!",width/2,height/7);
  }
  if (poseLabel == 'c'){
    fill(245,189,224);
    text("Warrior I correct!",width/2,height/7);
  }
}